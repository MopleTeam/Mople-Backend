package com.mople.global.event.data.handler.domain.impl.comment.notify;
...
public class CommentUpdatedMentionNotifyHandler implements DomainEventHandler<CommentUpdatedEvent> {
    ...
    @Override
    public Class<CommentUpdatedEvent> supports() {
